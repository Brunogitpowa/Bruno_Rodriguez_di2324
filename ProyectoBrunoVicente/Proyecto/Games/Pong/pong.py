...
ruta_bg = os.path.join(os.path.dirname(
        __file__), "assets/bg.png")
ruta_ball = os.path.join(os.path.dirname(
        __file__), "assets/ball.jpeg")
ruta_p1 = os.path.join(os.path.dirname(
        __file__), "assets/player1.jpeg")
ruta_p2 = os.path.join(os.path.dirname(
        __file__), "assets/player2.jpeg")
font = pygame.font.Font(None, 30)
screen = pygame.display.set_mode(SCREEN_SIZE)
clock = pygame.time.Clock()

bg = pygame.image.load(ruta_bg)
ball_img = pygame.image.load(ruta_ball)
player1_img = pygame.image.load(ruta_p1)
player2_img = pygame.image.load(ruta_p2)
